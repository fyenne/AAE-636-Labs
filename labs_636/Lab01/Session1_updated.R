...
cdfeasy <- ecdf(mysample)    # P is a function giving the empirical CDF of X
...
# fyx*Y is not what we want, R is very tricky in the matrix and vector operation
# [,1] [,2]
# [1,]  0.0  0.2
# [2,]  0.7  0.0
# [3,]  0.0  0.5
...
# [5,]  0.0  0.9
# 
# t(t(fyx)*Y) this is the matrix we would like to generate
# [,1] [,2]
# [1,]    0  0.2
# [2,]    0  0.3
# [3,]    0  0.5
