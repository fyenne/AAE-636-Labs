...
setwd("/Users/SunnyJieFeng/AAE636/Session0")
getwd()
...
persp(x,y,fa,theta=30,phi=20)   # @perspective plot
...
Auto=read.table("Auto.data",header=T  #  T = two 
                ,na.strings="?")
#fix(Auto)  # fix invokes edit on x and 
        # then assigns the new (edited) 
        # version of x in the user's workspace.
#View(Auto)
Auto=read.csv("../R_lab/Lab0/Auto.csv",header=T,na.strings="?")
dim(Auto)
Auto[1:4,]
Auto[1:4,]
#Auto=na.omit(Auto)
